...
class BlogtruyenSpider(scrapy.Spider):
    ...
    start_urls = ['http://blogtruyen.com/ajax/Search/AjaxLoadListManga?key=tatca&orderBy=3&p={}']
    page_numb = 653
    ...
    def parse_item(self, response):
        ...
        manga.add_xpath('name', '//title/text()', MapCompose(lambda x: x.split(' | ')[0], str.strip))
